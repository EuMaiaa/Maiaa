...
local Window = OrionLib:MakeWindow({Name = "MAIA hub❤️‍🔥", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "MAIA hub❤️‍🔥"})

OrionLib:MakeNotification({
	Name = "MAIA hub❤️‍🔥",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://4568348202",
	Time = 7
})
